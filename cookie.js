...
const config = {
    ...
    toggleStyle: {
        ...
        height: '26px',
        sliderSize: '20px'
         position: 'right' // Add this property
    },
...
/* Add this new rule to ensure toggle switches stay on the right */
.cookie-category .toggle-container {
...
/* Make the toggle switches more resistant to override */
